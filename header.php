...
{
  $header=mysqli_query($conn,"select * from profiles where user_email='{$_SESSION['email1']}'");
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item cta mr-md-2"><a href="login.php" class="nav-link"><?php if(empty($name)) {echo $_SESSION['email1'];} else{echo $name;} ?></a></li>           
	          

            <li class="nav-item ">
              <div class="dropdown">
                <img src="profile_img/<?php if(empty($img)){echo "logo.png";}else{echo $img;}?>" alt="Cinque Terre" class="img-circle dropdown-toggle" type="button" data-toggle="dropdown" width="50" height="50" >
